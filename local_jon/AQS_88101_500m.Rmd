...
250m of an existing location will assigned to that "known location". New "known locations"
...
distance_table <- 
  ...
  MazamaLocationUtils::table_findAdjacentDistances(distanceThreshold = 500)
...
known_locations_0 %>%
  MazamaLocationUtils::table_findAdjacentLocations(distanceThreshold = 500) %>%
  table_leaflet()
```
