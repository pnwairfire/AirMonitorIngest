...
```{r leaflet}
# Wich sites are too close
rows <- c(tbl$row1, tbl$row2) %>% sort()
too_close <- known_locations_0[rows,]

table_leaflet(too_close)
```

### Manual Editing

Starting in Alaska, we will work our way through all "too close" sites and 
